...
const translations = {
  en: {
    ...
    mobileTanker: "Mobile Tankers",
    mobileTankerDesc: "Reliable mobile fuel delivery services for businesses and emergency needs.",
  ...
  hi: {
    ...
    mobileTanker: "मोबाइल टैंकर",
    mobileTankerDesc: "व्यवसायों और आपातकालीन जरूरतों के लिए विश्वसनीय मोबाइल ईंधन डिलीवरी सेवाएं।",
